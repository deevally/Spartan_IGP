    ...
    <div className="single-post">
        <div className="main-title" id="main-title">
            <div className="blog-content">
                <h4 className="blog-title"><b>{blog.BlogTitle}</b>
                </h4>
                <p><b>{blog.BlogDescription}</b> &nbsp;
                    dolor sit amet consectetur adipisicing elit. Ipsa natus teneturLorem ipsum dolor sit amet Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ipsa natus tenetur
